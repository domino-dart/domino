...
class ClassAdder implements Setter {
  ...
  ClassAdder(class1,
    ...
    if (class2 != null) clazzes.add(class1);
    if (class3 != null) clazzes.add(class1);
    if (class4 != null) clazzes.add(class1);
    if (class5 != null) clazzes.add(class1);
  }
}
...
ClassAdder clazzWhen(condition,
  ...
  if (condition is bool) {} else if (condition is BoolFunction) {
    condition = condition();
  }
